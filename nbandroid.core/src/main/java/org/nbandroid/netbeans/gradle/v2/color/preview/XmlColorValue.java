 ...
 * @author arsi
 */
public class XmlColorValue extends AbstractColorValue {

    private final Color color;

    public XmlColorValue(@NonNull ColorCodesProvider colorCodesProvider, Color color, String value, int startOffset, int endOffset, int line) {
