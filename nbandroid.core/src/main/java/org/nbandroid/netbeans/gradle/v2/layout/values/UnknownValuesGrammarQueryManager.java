...
public class UnknownValuesGrammarQueryManager extends GrammarQueryManager {

    private static final GrammarQuery QUERY;

    static {
        QUERY = DTDUtil.parseDTD(true, new InputSource(AndroidStyleable.class.getResourceAsStream("all.dtd")));
    }

    public UnknownValuesGrammarQueryManager() {
    }
