...
@MIMEResolver.Registration(
        ...
        displayName = "Android symbols.xml"
)
...
public class SymbolsDataObject extends MultiDataObject {

    public static final String SETTINGS_MIME_TYPE = "text/x-android-symbols+xml";
