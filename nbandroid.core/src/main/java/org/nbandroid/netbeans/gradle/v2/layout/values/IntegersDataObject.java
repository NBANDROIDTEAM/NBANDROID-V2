...
@MIMEResolver.Registration(
        ...
        displayName = "Android integers.xml"
)
...
public class IntegersDataObject extends MultiDataObject {

    public static final String SETTINGS_MIME_TYPE = "text/x-android-integer+xml";
