...
package org.nbandroid.netbeans.gradle.v2.manifest;
...
public final class ManifestData {
     ...
     * {@code <uses-feature>} node with the attribute glEsVersion set.
     */
    ...
    /**
     * List of all activities, services, receivers and providers to keep for
     * Proguard and Dex *
     */
    ...
    public static final class Activity {
         ...
         * resets both flags. This is to handle multiple intent-filters where
         * one could have the valid action, and another one of the valid
         * category.
         */
    ...
    /**
     * Class representing the <code>supports-screens</code> node in the
     * manifest. By default, all the getters will return null if there was no
     * value defined in the manifest.
     *
    ...
    public static final class SupportsScreens {
        ...
        /**
         * Instantiate an instance from a string. The string must have been
         * created with {@link #getEncodedValues()}.
         *
         ...
         *
         * @param targetSdkVersion the target api level of the app, since this
         * has an effect on default values.
         */
        ...
        /**
         * returns the value of the <code>resizeable</code> attribute or null if
         * not present.
         */
        ...
        /**
         * returns the value of the <code>anyDensity</code> attribute or null if
         * not present.
         */
        ...
        /**
         * returns the value of the <code>smallScreens</code> attribute or null
         * if not present.
         */
        ...
        /**
         * returns the value of the <code>normalScreens</code> attribute or null
         * if not present.
         */
        ...
        /**
         * returns the value of the <code>largeScreens</code> attribute or null
         * if not present.
         */
        ...
        /**
         * Returns either {@link Boolean#TRUE} or {@link Boolean#FALSE} based on
         * the value of the given Boolean object.
         */
        ...
        /**
         * Returns true if the two instances support the same screen sizes. This
         * is similar to {@link #equals(Object)} except that it ignores the
         * values of {@link #getAnyDensity()} and {@link #getResizeable()}.
         *
         ...
         * support. This means that there is no screen size that they both
         * support.
         *
         * @param support the other instance to compare to.
        ...
        /**
         * Comparison of 2 Supports-screens. This only uses screen sizes
         * (ignores resizeable and anyDensity), and considers that
         * {@link #hasStrictlyDifferentScreenSupportAs(SupportsScreens)} returns
         * true and {@link #overlapWith(SupportsScreens)} returns false.
         *
         * @throws IllegalArgumentException if the two instanced are not
         * strictly different or overlap each other
        ...
        /**
         * Returns a string encoding of the content of the instance. This string
         * can be used to instantiate a {@link SupportsScreens} object through
        ...
        /**
         * Returns true if the two instance overlap with each other. This can
         * happen if one instances supports a size, when the other instance
         * doesn't while supporting a size above and a size below.
         *
    ...
    public static final class UsesFeature {
        ...
        /**
         * Returns the value of the glEsVersion attribute, or 0 if the attribute
         * was not present.
         */
    ...
    /**
     * Class representing the <code>uses-configuration</code> node in the
     * manifest.
     */
    public static final class UsesConfiguration {
        ...
        /**
         * returns the value of the <code>reqFiveWayNav</code> attribute or null
         * if not present.
         */
        ...
        /**
         * returns the value of the <code>reqHardKeyboard</code> attribute or
         * null if not present.
         */
        ...
        /**
         * returns the value of the <code>reqKeyboardType</code> attribute or
         * null if not present.
         */
    ...
    /**
     * Returns the list of activities, services, receivers and providers found
     * in the manifest.
     *
     * @return An array of fully qualified class names, or empty if no classes
     * to keep were found.
     */
     ...
     * Sets the value of the <code>minSdkVersion</code> attribute.
     *
     * @param targetSdkVersion the string value of the attribute in the
     * manifest.
     */
    ...
    /**
     * Returns the glEsVersion from a {@code <uses-feature>} or
