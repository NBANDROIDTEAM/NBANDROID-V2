...
import org.nbandroid.netbeans.gradle.v2.manifest.ManifestData.Activity;
import org.nbandroid.netbeans.gradle.v2.manifest.ManifestData.Instrumentation;
import org.nbandroid.netbeans.gradle.v2.manifest.ManifestData.SupportsScreens;
import org.nbandroid.netbeans.gradle.v2.manifest.ManifestData.UsesConfiguration;
import org.nbandroid.netbeans.gradle.v2.manifest.ManifestData.UsesFeature;
import org.nbandroid.netbeans.gradle.v2.manifest.ManifestData.UsesLibrary;
...
/**
 * Full Manifest parser that parses the manifest in details, including
 * activities, instrumentations, support-screens, and uses-configuration.
 */
public class AndroidManifestParser {
    ...
    public interface ManifestErrorHandler extends ErrorHandler {
         ...
         * <p>
         * Errors are put as {@code org.eclipse.core.resources.IMarker} on the
         * manifest file.
         *
    ...
    /**
     * XML error and data handler used when parsing the AndroidManifest.xml
     * file.
     * <p>
    ...
    private static class ManifestHandler extends DefaultHandler {
         ...
         *
         * @param manifestData Class containing the manifest info obtained
         * during the parsing.
        ...
        /**
         * Combines a java package, with a class value from the manifest to make
     ...
     * @return A class containing the manifest info obtained during the parsing,
     * or null on error.
     ...
     * {@code parse(manifestFile, true, null)}.
     *
