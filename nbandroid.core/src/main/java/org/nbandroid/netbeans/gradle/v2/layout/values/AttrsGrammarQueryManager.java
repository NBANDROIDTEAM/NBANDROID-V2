...
public class AttrsGrammarQueryManager extends GrammarQueryManager {

    private static final GrammarQuery QUERY;

    static {
        QUERY = DTDUtil.parseDTD(true, new InputSource(AndroidStyleable.class.getResourceAsStream("attrs.dtd")));
    }

    public AttrsGrammarQueryManager() {
    }
