...
@ActionID(
        ...
        id = "org.nbandroid.netbeans.gradle.v2.nodes.actions.AddGoogleDependencyAction"
)
@ActionRegistration(
        displayName = "", lazy = false
)
public class AddGoogleDependencyAction extends NodeAction {
        ...
        if (activatedNodes.length == 1) {
            ...
            if (project != null && dialogProvider != null) {
                ...
                if (repositoriesProvider != null) {
                    ...
                    String mavenUrl = dialogProvider.showAddGoogleDependencyDialog(repositories, packages);
                    if (mavenUrl != null) {
    ...
    public String getName() {
        return "Add Google Android dependency";
    }
