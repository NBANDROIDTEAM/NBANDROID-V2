...
public class AndroidProjectTemplatePanelTvActivityAndroidSettings extends JPanel implements ItemListener, AndroidActivityTemplateHandler {

    private AndroidProjectTemplateWizardPanelTvActivityAndroidSettings panel;
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(AndroidProjectTemplatePanelTvActivityAndroidSettings.class, "AndroidProjectTemplatePanelTvActivityAndroidSettings.jLabel3.text")); // NOI18N
    ...
    void store(WizardDescriptor d) {
        d.putProperty(PROP_TV_TEMPLATE, currentTemplate);
    }
