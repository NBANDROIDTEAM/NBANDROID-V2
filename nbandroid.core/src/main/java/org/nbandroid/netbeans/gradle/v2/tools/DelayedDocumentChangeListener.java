...
package org.nbandroid.netbeans.gradle.v2.tools;
...
public final class DelayedDocumentChangeListener implements DocumentListener {
    ...
    /**
     * on typing is ChangeListeners ChangeEvent called with null on done is
     * ChangeListeners ChangeEvent called with Document as event source
     *
     * @param doc
     * @param l
     * @param delay
