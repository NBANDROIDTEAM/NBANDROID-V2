 ...
 * <p>
 * Unlike the more general {@link Template} which is used to instantiate full
 * template files (from resources, merging into existing files etc) this
...
public class StringEvaluator implements TemplateLoader {
    ...
    public String evaluate(@NonNull String expression, @NonNull Map<String, Object> inputs) {
        try {
            ...
            Map<String, Object> args = TemplateUtils.createParameterMap(inputs);
