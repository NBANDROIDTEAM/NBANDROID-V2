...
public class ArrayGrammarQueryManager extends GrammarQueryManager {

    private static final GrammarQuery QUERY;

    static {
        QUERY = DTDUtil.parseDTD(true, new InputSource(AndroidStyleable.class.getResourceAsStream("array.dtd")));
    }

    public ArrayGrammarQueryManager() {
    }
