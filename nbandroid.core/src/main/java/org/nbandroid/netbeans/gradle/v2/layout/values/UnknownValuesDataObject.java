...
@MIMEResolver.Registration(
        ...
        displayName = "Android values.xml"
)
...
public class UnknownValuesDataObject extends MultiDataObject {

    public static final String SETTINGS_MIME_TYPE = "text/x-android-values+xml";
