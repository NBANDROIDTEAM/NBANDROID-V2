 ...
 * @author arsi
 */
public class DebugCustomizerProvider implements ProjectCustomizer.CompositeCategoryProvider {

    private static final String CUSTOMIZER_RUN = "Debug";
    private static final String CUSTOMIZER_RUN_MAIN_ACTIVITY = "Main Activity";

    @ProjectCustomizer.CompositeCategoryProvider.Registration(
            projectType = "android-project", position = 45)
    public static DebugCustomizerProvider createRunCustomizerProvider() {
        return new DebugCustomizerProvider();
    }

    @Override
    public ProjectCustomizer.Category createCategory(Lookup context) {
        return ProjectCustomizer.Category.create(CUSTOMIZER_RUN, "Debug", null,
    ...
    public JComponent createComponent(ProjectCustomizer.Category category, Lookup context) {
        switch (category.getName()) {
            ...
            case CUSTOMIZER_RUN_MAIN_ACTIVITY:
                DebugActivityConfiguration runActivityConfiguration = context.lookup(Project.class).getLookup().lookup(DebugActivityConfiguration.class);
