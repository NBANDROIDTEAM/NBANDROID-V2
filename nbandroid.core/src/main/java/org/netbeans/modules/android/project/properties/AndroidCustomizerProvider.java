 ...
 * @author arsi
 */
public class AndroidCustomizerProvider implements CustomizerProvider {

    public static final String CUSTOMIZER_FOLDER_PATH
            = "Projects/android-project/Customizer";

    private final NbAndroidProjectImpl project;

    public AndroidCustomizerProvider(NbAndroidProjectImpl project) {
