 ...
 * @author arsi
 */
@ServiceProvider(service = NodeFactory.class, path = "Android/RootProject/NodeFactory", position = 2000)
public class ProjectFilesNodeFactory implements NodeFactory {
    ...
    public static class ProjectFilesChildFactory2 extends Children.Keys<Node> implements ChangeListener {
        ...
        public ProjectFilesChildFactory2(Project project) {
            ...
            List<MultiNodeFactoryProvider> providers = MultiNodeFactoryProvider.findAllForRoot("ProjectFiles");
        ...
        public void stateChanged(ChangeEvent e) {
            ...
            List<NodeFactory> findAll = NodeFactory.findAllForRoot("ProjectFiles");
