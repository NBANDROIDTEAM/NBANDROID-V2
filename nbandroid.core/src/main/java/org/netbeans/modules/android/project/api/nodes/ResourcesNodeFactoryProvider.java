 ...
 * @author arsi
 */
@ServiceProvider(service = MultiNodeFactoryProvider.class, path = "Android/Project/NodeFactory", position = 200)
public class ResourcesNodeFactoryProvider implements MultiNodeFactoryProvider {

    @Override
    public MultiNodeFactory createMultiNodeFactory(Project p) {
        return new ResourcesNodeFactory(p);
    }

    public static class ResourcesNodeFactory implements MultiNodeFactory, ChangeListener {
        ...
        public ResourcesNodeFactory(Project p) {
            this.p = p;
