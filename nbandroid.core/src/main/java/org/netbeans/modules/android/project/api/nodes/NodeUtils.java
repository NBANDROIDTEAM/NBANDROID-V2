...
public class NodeUtils {
    ...
    String ICON_PATH = "org/netbeans/modules/android/project/api/nodes/defaultFolder.gif"; // NOI18N
    private static final @StaticResource
    String OPENED_ICON_PATH = "org/netbeans/modules/android/project/api/nodes/defaultFolderOpen.gif"; // NOI18N
