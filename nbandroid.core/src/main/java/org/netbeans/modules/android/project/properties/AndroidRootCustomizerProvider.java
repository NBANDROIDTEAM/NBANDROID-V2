 ...
 * @author arsi
 */
public class AndroidRootCustomizerProvider implements CustomizerProvider {

    public static final String CUSTOMIZER_FOLDER_PATH
            = "Projects/android-root-project/Customizer";

    private final NbAndroidRootProjectImpl project;

    public AndroidRootCustomizerProvider(NbAndroidRootProjectImpl project) {
