 ...
 * @author arsi
 */
@ServiceProvider(service = NodeFactory.class, path = "Android/Project/NodeFactory", position = 500)
public class GeneratedSourcesNodeFactory implements NodeFactory {
