...
import org.netbeans.modules.android.project.properties.ui.BuildCustomizerPanel;
...
public class BuildCustomizerProvider implements ProjectCustomizer.CompositeCategoryProvider {
    ...
    @ProjectCustomizer.CompositeCategoryProvider.Registration(
            projectType = "android-project", position = 11)
    public static BuildCustomizerProvider createAndroidBuildCustomizerProvider() {
        return new BuildCustomizerProvider();
    }
