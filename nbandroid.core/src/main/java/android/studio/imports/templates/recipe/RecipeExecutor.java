...
public interface RecipeExecutor {
    ...
    /**
     * Instantiates the given template file into the given output file (running
     * the freemarker engine over it)
     */
    ...
    /**
     * Create a directory at the specified location (if not already present).
    ...
    /**
     * Adds "apply plugin: '{@code plugin}'" statement to the module
     * build.gradle file.
     */
    ...
    /**
     * Update the project's gradle build file and sync, if necessary. This
     * should only be called once and after all dependencies are already added.
     */
    void updateAndSync();
