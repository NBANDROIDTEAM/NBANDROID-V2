...
/**
 * Provides {@link FolderConfiguration} and {@link HardwareConfig} for various
 * devices. Also provides utility methods to parse build.prop and attrs.xml to
