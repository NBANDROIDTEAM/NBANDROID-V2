...
public class ModuleClassLoader extends ClassLoader {
    ...
    /**
     * @param buildRoot The path to the module root
     * @param parent The parent class loader
     */
    public ModuleClassLoader(String buildRoot, ClassLoader parent) {
        super(parent);
        myModuleRoot = buildRoot + (buildRoot.endsWith("/") ? "" : "/");
    }
    ...
    protected Class<?> findClass(String name) throws ClassNotFoundException {
        ...
        if (clazz == null) {
            ...
            try {
                byte[] b = Streams.readFully(new FileInputStream(new File(myModuleRoot + path)));
