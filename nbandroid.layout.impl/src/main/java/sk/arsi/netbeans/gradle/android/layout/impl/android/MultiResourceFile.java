...
import sk.arsi.netbeans.gradle.android.layout.impl.android.ValueResourceParser.IValueResourceRepository;
...
public final class MultiResourceFile extends ResourceFile implements IValueResourceRepository {
    ...
    public MultiResourceFile(IAbstractFile file, ResourceFolder folder, ResourceNamespace namespace) {
        super(file, folder);
    ...
    private void parseFile() {
        try {
            ...
            parser.parse(getFile().getContents(), new ValueResourceParser(this, isFramework(), null, namespace));
