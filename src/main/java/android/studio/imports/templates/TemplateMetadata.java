...
public class TemplateMetadata {
    ...
    public TemplateMetadata(@NotNull Document document) {
        ...
        NodeList parameters = myDocument.getElementsByTagName(Template.TAG_PARAMETER);
        ...
        NodeList icons = myDocument.getElementsByTagName(Template.TAG_ICONS);
    ...
    public String getTitle() {
        return getAttrNonEmpty(Template.ATTR_NAME);
    }
    ...
    /**
     * Get the active thumbnail path, which requires a callback that takes a
     * parameter ID and returns its value. Using that information, we can select
     * the associated thumbnail path and return it.
     */
    @Nullable
    public String getThumbnailPath(Function<String, Object> produceParameterValue) {
        ...
        // of conditions.
        NodeList thumbs = myDocument.getElementsByTagName(Template.TAG_THUMB);
    ...
    public boolean isSupported() {
        String versionString = myDocument.getDocumentElement().getAttribute(Template.ATTR_FORMAT);
        if (versionString != null && !versionString.isEmpty()) {
            try {
                int version = Integer.parseInt(versionString);
                return version <= Template.CURRENT_FORMAT;
    ...
    public boolean useImplicitRootFolder() {
        String format = myDocument.getDocumentElement().getAttribute(Template.ATTR_FORMAT);
