...
public final class Parameter {
     ...
     * validator etc for user input. These are typically combined into a set of
     * constraints via an EnumSet.
     */
    public enum Constraint {
        ...
        UNIQUE,
        /**
         * This value must already exist. This constraint usually only makes
         * sense when other constraints are specified, such as {@link #LAYOUT},
         * which means that the parameter should designate a name that already
         * exists as a resource name.
         */
        EXISTS,
        /**
        ...
        EMPTY,
        /**
         * The associated value should represent a fully qualified activity
         * class name
         */
        ACTIVITY,
        /**
        ...
        PACKAGE,
        /**
         * The associated value should represent a valid Android application
         * package name
         */
        APP_PACKAGE,
        /**
    ...
    /**
     * A template expression using other template parameters for dynamically
     * changing the visibility of this parameter to the user.
     */
    @Nullable
    ...
    /**
     * A template expression using other template parameters for dynamically
     * changing whether this parameter is enabled for the user.
     */
    @Nullable
