...
public class AndroidProjectTemplateWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
            ...
            new AndroidProjectTemplateWizardPanelConfigureActivityAndroidSettings(),
            new AndroidProjectTemplateWizardPanelWearActivityAndroidSettings(),
            new AndroidProjectTemplateWizardPanelTvActivityAndroidSettings()};
    }

    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(AndroidProjectTemplateWizardIterator.class, "LBL_CreateProjectStep"), "Android platform",
            "Mobile Activity", "Configure Mobile Activity", "Wear Activity", "TV Activity"
        };
    }
