...
@MIMEResolver.Registration(
        ...
        displayName = "Android styles.xml"
)
@DataObject.Registration(
        mimeType = "text/x-android-styles+xml",
        iconBase = "org/nbandroid/netbeans/gradle/v2/layout/icons-styles-16.png",
        displayName = "styles.xml",
        position = 300
)
public class StylesDataObject extends MultiDataObject {

    public static final String SETTINGS_MIME_TYPE = "text/x-android-styles+xml";
