...
public class BoolsGrammarQueryManager extends GrammarQueryManager {

    private static final GrammarQuery QUERY;

    static {
        QUERY = DTDUtil.parseDTD(true, new InputSource(AndroidStyleable.class.getResourceAsStream("bools.dtd")));
    }

    public BoolsGrammarQueryManager() {
    }
