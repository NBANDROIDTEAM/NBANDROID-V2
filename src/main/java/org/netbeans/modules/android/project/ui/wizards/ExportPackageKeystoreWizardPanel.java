...
public class ExportPackageKeystoreWizardPanel implements WizardDescriptor.Panel {

  private WizardDescriptor wizardDescriptor;
  /** The visual component that displays this panel. */
  private ExportPackageKeystoreVisualPanel component;

  @Override
  public ExportPackageKeystoreVisualPanel getComponent() {
    if (component == null) {
      component = new ExportPackageKeystoreVisualPanel(this);
    }
    return component;
  }
