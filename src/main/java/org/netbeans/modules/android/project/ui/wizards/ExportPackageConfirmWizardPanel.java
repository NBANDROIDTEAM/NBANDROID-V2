...
public class ExportPackageConfirmWizardPanel implements WizardDescriptor.FinishablePanel {

  private WizardDescriptor wizardDescriptor;
  /** The visual component that displays this panel. */
  private ExportPackageConfirmVisualPanel component;

  @Override
  public ExportPackageConfirmVisualPanel getComponent() {
    if (component == null) {
      component = new ExportPackageConfirmVisualPanel(this);
    }
    return component;
  }
  ...
  public boolean isFinishPanel() {
    return getComponent().isFinishable();
  }
