...
public class ExportPackageAliasWizardPanel implements WizardDescriptor.Panel {

  private WizardDescriptor wizardDescriptor;
  /** The visual component that displays this panel. */
  private ExportPackageAliasVisualPanel component;

  @Override
  public ExportPackageAliasVisualPanel getComponent() {
    if (component == null) {
      component = new ExportPackageAliasVisualPanel(this);
    }
    return component;
  }
